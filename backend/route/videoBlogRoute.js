...
import { addVideoBlog, deleteVideoBlog, getRawVideo, getRawVideoById, getVideoBlog, getVideoBlogById, getYoutubeVideo, updateVideoBlog } from '../controller/VideoBlogsController.js';
...
videoBlogRoute.post("/updateVideo/:videoId",protect,restrictTo("admin","user"),updateVideoBlog)
videoBlogRoute.delete("/deleteVideo/:videoId",protect,restrictTo("admin"),deleteVideoBlog)
